...
export class InjectComponent extends Component<Props> {
  ...
  render() {
    ...
    const Injected = React.lazy(() => import(
      /*
      webpackExclude: /(divider|extendedpicker|floatingpicker|pickers|selectableoption|selecteditemslist|ScrollablePane|splitbutton|documentcard|contextualmenu|datepicker|icon|link|modal)$/i,
