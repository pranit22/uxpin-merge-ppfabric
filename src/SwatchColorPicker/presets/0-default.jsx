...
export class SwatchColorPickerBasicExample extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            color: undefined,
    ...
    render() {
        ...
        <SwatchColorPicker columnCount={5} selectedId={this.state.color} cellShape={'circle'} colorCells={[
        ...
        <SwatchColorPicker columnCount={5} selectedId={this.state.color} cellShape={'square'} colorCells={[
            { id: 'a', label: 'orange', color: '#ca5010' },
            { id: 'b', label: 'cyan', color: '#038387' },
            { id: 'c', label: 'blueMagenta', color: '#8764b8' },
            { id: 'd', label: 'magenta', color: '#881798' },
        ...
        <SwatchColorPicker columnCount={5} cellHeight={35} cellWidth={35} selectedId={this.state.color} cellShape={'square'} colorCells={[
            { id: 'a', label: 'orange', color: '#ca5010' },
            { id: 'b', label: 'cyan', color: '#038387' },
            { id: 'c', label: 'blueMagenta', color: '#8764b8' },
            { id: 'd', label: 'magenta', color: '#881798' },
        ...
        <SwatchColorPicker selectedId={this.state.color} 
        // tslint:disable:jsx-no-lambda
        onCellHovered={(id, color) => this.setState({ previewColor: color })} onCellFocused={(id, color) => this.setState({ previewColor: color })} 
        ...
        <SwatchColorPicker disabled={true} columnCount={5} selectedId={this.state.color} cellShape={'circle'} colorCells={[
            { id: 'a', label: 'orange', color: '#ca5010' },
            { id: 'b', label: 'cyan', color: '#038387' },
            { id: 'c', label: 'blueMagenta', color: '#8764b8' },
            { id: 'd', label: 'magenta', color: '#881798' },
...
export default SwatchColorPickerBasicExample;
