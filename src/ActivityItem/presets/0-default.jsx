...
import { ActivityItem, css, classNamesFunction, Icon, Link } from 'office-ui-fabric-react';
const exampleStyles = {
    exampleRoot: {
        marginTop: '20px'
    },
        ...
        const activityItemExamples = [
            {
                key: 1,
                activityDescription: [
                    <Link key={1} className={css(classNames.nameText)} onClick={() => {
            ...
            Philippe Lampros
                ...
                comments: [
                    ...
                    <Link key={2} className={css(classNames.nameText)} onClick={() => {
            ...
            Julian Arvidsson
                    ...
                    <Link key={3} className={css(classNames.nameText)} onClick={() => {
                        alert('A document was clicked.');
                    }}>
            PresentationTitle.pptx
          </Link>,
                    <span key={4}> to </span>,
                    <Link key={5} className={css(classNames.nameText)} onClick={() => {
