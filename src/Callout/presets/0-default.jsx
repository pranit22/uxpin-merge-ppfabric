...
// Example code
export class CalloutBasicExample extends React.Component {
    constructor() {
        super(...arguments);
        this.state = {
        ...
        this._labelId = getId('callout-label');
    ...
    render() {
        ...
        <Callout className="ms-CalloutExample-callout" ariaLabelledBy={this._labelId} ariaDescribedBy={this._descriptionId} role="alertdialog" gapSpace={0} target={this._menuButtonElement.current} onDismiss={this._onCalloutDismiss} setInitialFocus={true} hidden={!this.state.isCalloutVisible}>
