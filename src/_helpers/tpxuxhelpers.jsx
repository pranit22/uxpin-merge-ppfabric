...
export const TpxUxDateTimeUtils = {
     ...
     * Returns an 'undefined' value if the entered value can't be parsed. 
     * @param {string} dateStr - A string representation of a valid date.
     * @param {string} in12HrFormat - True for the 12 hr format, false for the 24 hr format. AM/PM is appended to the 12 hour format.
     * @param {string} withSeconds - True to include seconds. 
     */
