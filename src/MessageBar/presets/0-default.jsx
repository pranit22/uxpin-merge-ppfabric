...
export const MessageBarBasicExample = () => (<Stack tokens={{ childrenGap: 20 }}>
    <StackItem>
    ...
    <StackItem>
      ...
      <MessageBar messageBarType={MessageBarType.blocked} isMultiline={false} onDismiss={log('test')} dismissButtonAriaLabel="Close" truncated={true} overflowButtonAriaLabel="See more">
    ...
    <StackItem>
      ...
      <MessageBar messageBarType={MessageBarType.severeWarning} actions={<div>
    ...
    <StackItem>
      ...
      <MessageBar actions={<div>
            <MessageBarButton>Yes</MessageBarButton>
            <MessageBarButton>No</MessageBarButton>
          </div>} messageBarType={MessageBarType.success} isMultiline={false}>
    ...
    <StackItem>
      ...
      <MessageBar messageBarType={MessageBarType.warning} isMultiline={false} onDismiss={log('test')} dismissButtonAriaLabel="Close" actions={<div>
    ...
    <StackItem>
      ...
      <MessageBar onDismiss={log('test')} dismissButtonAriaLabel="Close" messageBarType={MessageBarType.warning} ariaLabel="Aria help text here" actions={<div>
            <MessageBarButton>Yes</MessageBarButton>
            <MessageBarButton>No</MessageBarButton>
          </div>}>
