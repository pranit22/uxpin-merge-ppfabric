...
export class ModalBasicExample extends React.Component {
    ...
    render() {
        ...
        <Modal titleAriaId={this._titleId} subtitleAriaId={this._subtitleId} isOpen={this.state.showModal} onDismiss={this._closeModal} isBlocking={false} containerClassName={styles.container} dragOptions={this.state.isDraggable ? this._dragOptions : undefined}>
